...
<body style="display: flex; flex-direction: column; align-items: center;">
	...
	// 쿼리문 생성
	String sql = "SELECT COUNTRY.REGION, COUNTRY.NAME FROM COUNTRYLANGUAGE, COUNTRY WHERE COUNTRYLANGUAGE.LANGUAGE = ? AND COUNTRYLANGUAGE.ISOFFICIAL = ? AND COUNTRYLANGUAGE.COUNTRYCODE = COUNTRY.CODE ORDER BY COUNTRY.REGION ASC, COUNTRY.NAME ASC;";
