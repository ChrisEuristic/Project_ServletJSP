...
<body style="display: flex; flex-direction: column; align-items: center;">
	...
	// 쿼리문 생성
	String sql = "SELECT COUNTRYLANGUAGE.LANGUAGE FROM COUNTRY, COUNTRYLANGUAGE WHERE COUNTRY.NAME = ? AND COUNTRY.CODE = COUNTRYLANGUAGE.COUNTRYCODE;";
	PreparedStatement stmt = jdbc.con.prepareStatement(sql);
	stmt.setString(1, "South Korea");
